...
export const wrapperClasses: Record<RequiredToastProps['type'], string> = {
  ...
  error: 'bg-red-500 dark:bg-red-700 dark:text-red-100',
};
...
//   error: "dark:bg-red-100 bg-red-700/80 text-white dark:text-red-500",
// };

export const closeButtonClasses =
  'w-4 h-4 mx-3 items-center justify-center text-gray-400 dark:text-gray-200 text-white hover:text-gray-200 rounded-md focus:ring-2 focus:ring-gray-300 inline-flex';
